...
func (c *msgClient) CreateStream(ctx context.Context, in *MsgCreateStream, opts ...grpc.CallOption) (*MsgCreateStreamResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_CreateStream_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimStream(ctx context.Context, in *MsgClaimStream, opts ...grpc.CallOption) (*MsgClaimStreamResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_ClaimStream_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) TopUpDeposit(ctx context.Context, in *MsgTopUpDeposit, opts ...grpc.CallOption) (*MsgTopUpDepositResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_TopUpDeposit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateFlowRate(ctx context.Context, in *MsgUpdateFlowRate, opts ...grpc.CallOption) (*MsgUpdateFlowRateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UpdateFlowRate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelStream(ctx context.Context, in *MsgCancelStream, opts ...grpc.CallOption) (*MsgCancelStreamResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_CancelStream_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) ClaimStream(context.Context, *MsgClaimStream) (*MsgClaimStreamResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ClaimStream not implemented")
}
func (UnimplementedMsgServer) TopUpDeposit(context.Context, *MsgTopUpDeposit) (*MsgTopUpDepositResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TopUpDeposit not implemented")
}
func (UnimplementedMsgServer) UpdateFlowRate(context.Context, *MsgUpdateFlowRate) (*MsgUpdateFlowRateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateFlowRate not implemented")
}
