...
//	//if config.GetBech32AccountAddrPrefix() != appparams.Bech32PrefixAccAddr {
...
//		Coins:   sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, mathmod.NewInt(100000000000000))),
//	}
//
...
//	app.BeaconKeeper.SetParams(sdkCtx, beacontypes.NewParams(24, 2, 2, sdk.DefaultBondDenom, TestDefaultStorage, TestMaxStorage))
//	app.WrkchainKeeper.SetParams(sdkCtx, wrkchaintypes.NewParams(24, 2, 2, sdk.DefaultBondDenom, TestDefaultStorage, TestMaxStorage))
...
//	})
//	_ = app.EnterpriseKeeper.SetTotalLockedUnd(sdkCtx, sdk.NewInt64Coin(sdk.DefaultBondDenom, 0))
//	_ = app.EnterpriseKeeper.SetTotalSpentEFUND(sdkCtx, sdk.NewInt64Coin(sdk.DefaultBondDenom, 0))
