...
func addTestnetFlagsToCmd(cmd *cobra.Command) {
	...
	cmd.Flags().StringP(flagOutputDir, "o", "/tmp/fund-testnet", "Directory to store initialization data for the testnet")
...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, ".und_mainchain", "Home directory of the node's daemon configuration")
...
func startTestnet(cmd *cobra.Command, args startArgs) error {
	networkConfig := network.DefaultConfig(simapphelpers.NewTestNetworkFixture)
