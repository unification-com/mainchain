...
echo "Now run:"
echo ""
echo "   # rootless docker: reclaim ownership without sudo via a root container"
echo "   docker run --rm -v \$(pwd):/workspace --workdir /workspace --user 0:0 alpine chown -R 0:0 github.com"
