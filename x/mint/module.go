...
type AppModule struct {
	...
	entKeeper  types.EnterpriseKeeper
}

// NewAppModule creates a new AppModule object
func NewAppModule(cdc codec.Marshaler, keeper keeper.Keeper, ak types.AccountKeeper, ek types.EnterpriseKeeper) AppModule {
	return AppModule{
...
func (am AppModule) BeginBlock(ctx sdk.Context, _ abci.RequestBeginBlock) {
	BeginBlocker(ctx, am.keeper, am.entKeeper)
}
