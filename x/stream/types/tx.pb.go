...
type MsgClaimStreamResponse struct {
	// total_claimed is the total amount claimed
	TotalClaimed types.Coin `protobuf:"bytes,1,opt,name=total_claimed,json=totalClaimed,proto3" json:"total_claimed"`
	// validator_bonus is the amount sent to validators
	ValidatorBonus types.Coin `protobuf:"bytes,2,opt,name=validator_bonus,json=validatorBonus,proto3" json:"validator_bonus"`
}
...
func (m *MsgClaimStreamResponse) GetValidatorBonus() types.Coin {
	if m != nil {
		return m.ValidatorBonus
	}
	return types.Coin{}
}
...
var fileDescriptor_887eb49d9c70e8b4 = []byte{
	...
	,
}
...
func (m *MsgClaimStreamResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.ValidatorBonus.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgClaimStreamResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidatorBonus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ValidatorBonus.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
